...
public final class ACompletoAstComandoSe extends PAstComandoSe
{
    private PExpLogica _expLogica_;
    private final LinkedList<PConjComandos> _conjComandos_ = new LinkedList<PConjComandos>();

    public ACompletoAstComandoSe()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACompletoAstComandoSe(
    ...
    {
        ((Analysis) sw).caseACompletoAstComandoSe(this);
    }
