...
public final class AEnquantoAstComandoEnquanto extends PAstComandoEnquanto
{
    private PExpLogica _expLogica_;
    private final LinkedList<PConjComandos> _conjComandos_ = new LinkedList<PConjComandos>();

    public AEnquantoAstComandoEnquanto()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEnquantoAstComandoEnquanto(
    ...
    {
        ((Analysis) sw).caseAEnquantoAstComandoEnquanto(this);
    }
